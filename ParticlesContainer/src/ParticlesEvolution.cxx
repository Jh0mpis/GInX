 ...
 */
extern "C" void ParticlesContainer_setup(CCTK_ARGUMENTS) {
 ...
 * geodesic equations.
 */
extern "C" void ParticlesContainer_evolve(CCTK_ARGUMENTS) {
  DECLARE_CCTK_PARAMETERS;
  DECLARE_CCTK_ARGUMENTS;
 ...
 */
extern "C" void ParticlesContainer_print(CCTK_ARGUMENTS) {
  DECLARE_CCTK_PARAMETERS;
 ...
 */
extern "C" int ParticlesContainer_final_cleanup() {
